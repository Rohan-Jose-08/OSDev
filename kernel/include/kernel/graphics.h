...
// Graphics modes
#define MODE_TEXT       0
#define MODE_13H        1  // 320x200, 256 colors
#define MODE_320x240    2  // 320x240, 256 colors (Mode X)
#define MODE_640x480    3  // 640x480, 16 colors
...
// Basic drawing primitives (Mode 13h)
...
// Text rendering in graphics mode (8x8 font)
